...
As described in the Odin Project's Full Stack JS Develloper [Computer Science](https://www.theodinproject.com/lessons/javascript-binary-search-trees) module.
...
Also included is a script that tests most of the tree's function