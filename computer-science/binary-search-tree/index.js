...
console.log(`Tree travesed in level order is: ${binaryTree.levelOrderList}`) // [9, 5, 67, 1, 7, 23, 556, 3, 8, 27, 324, 6345, 36]
console.log("-------------------------------------------")
binaryTree.preorder(); // Returns array of tree values traverseed in level order 
console.log(`Tree travesed in preorder is: ${binaryTree.preorderList}`) // [9, 5, 67, 1, 7, 23, 556, 3, 8, 27, 324, 6345, 36]
